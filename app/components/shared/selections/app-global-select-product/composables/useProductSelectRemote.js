import { inventoryApi, mapInventoryProductOptions } from "~/services/inventory";
import { productApi } from "~/services/product";
import { mapCatalogProductOption } from "~/utils/productOptions";
...
export function useProductSelectRemote({
  ...
  const loadInventoryOptions = async (term = searchTerm.value) => {
    ...
    try {
      ...
      const items = await inventoryApi.getBranchInventory(props.branchId, {
