...
<script setup>
import LoginRightSide from "~/components/login/components/LoginRightSide.vue";
import LoginLeftSide from "~/components/login/components/LoginLeftSide.vue";

defineOptions({ name: "LoginPageIndex" });
</script>
