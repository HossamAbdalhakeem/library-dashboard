  ...
  <div v-if="reservation" class="flex flex-col gap-4">
    ...
    <div class="grid gap-3 md:grid-cols-2">
      <ExchangeReservationProductCard
        ...
        :teacher-name="reservation.product?.teacher?.name"
    ...
    <div class="flex flex-col gap-2 text-right">
      <AppGlobalSelectProduct
        ...
        :exclude-product-id="reservation.product?.id"
        label="المنتج الجديد"
  ...
  return [
    {
      key: "price",
      label: "السعر",
      value: r.product?.unitPriceLabel,
    },
    {
      key: "paid",
      label: "المدفوع",
      value: r.payment?.paidAmountLabel,
    },
    {
      key: "remaining",
      label: "المتبقي",
      value: r.payment?.remainingAmountLabel,
    },
  ];
});
