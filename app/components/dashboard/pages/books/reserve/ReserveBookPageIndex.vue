...
import BookReservationPageIndex from "~/components/dashboard/pages/reservations/book/BookReservationPageIndex.vue";
import { formatMoney } from "~/utils/format/money";

const BookSearchDialog = defineAsyncComponent(() =>
  import("~/components/dashboard/pages/books/components/dialog/BookSearchDialog.vue"),
);
