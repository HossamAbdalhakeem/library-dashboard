...
import { useBookingForm } from "./BookingForm/composables/useBookingForm";

defineOptions({ name: "DashboardBookingForm" });

const BookingFormOverlay = defineAsyncComponent(
  () => import("./BookingForm/partials/BookingFormOverlay.vue"),
);
const BookingFormHeader = defineAsyncComponent(
  () => import("./BookingForm/partials/BookingFormHeader.vue"),
);
const BookingFormFields = defineAsyncComponent(
  () => import("./BookingForm/partials/BookingFormFields.vue"),
);
